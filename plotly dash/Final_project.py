...
def get_graph(chart, year, children1, children2, c3, c4, c5):
    ...
    if chart=='OPT1':
        ...
        bar_fig = px.bar(bar_data, x='Month', y='Flights', color='CancellationCode', title='Monthly Flight Cancelation')
        ...
        # Number of flights to each state from each reporting airline
